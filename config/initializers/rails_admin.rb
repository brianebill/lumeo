# RailsAdmin config file. Generated on May 19, 2012 13:26
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Lumeo', 'Admin']
  ...
  # config.excluded_models = [Article, Assignment, CategoriesPosts, Category, Comment, Course, Micropost, Post, Relationship, Role, School, User, Video]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Article, Assignment, CategoriesPosts, Category, Comment, Course, Micropost, Post, Relationship, Role, School, User, Video]
  ...
  #   update do; end
  # end
  # config.model CategoriesPosts do
  #   # Found associations:
  #   # Found columns:
  #     configure :id, :integer 
  #     configure :created_at, :datetime 
  ...
  #   # Found associations:
  #     configure :posts, :has_and_belongs_to_many_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :name, :string 
  #     configure :created_at, :datetime 
  ...
  #     configure :micropost_id, :integer 
  #     configure :text, :text 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #   # Found columns:
  #     configure :id, :integer 
  #     configure :school_id, :integer 
  #     configure :title, :string 
  #     configure :total_running_time, :time 
  #     configure :show_text, :text 
  #     configure :index_text, :text 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime   #   # Sections:
  #   list do; end
  #   export do; end
  ...
  #     configure :index_text, :text 
  #     configure :show_text, :text 
  #     configure :created_date, :datetime 
  #     configure :edited_date, :datetime 
  ...
  #     configure :followed, :belongs_to_association   #   # Found columns:
  #     configure :id, :integer 
  ...
  #     configure :microposts, :has_many_association 
  ...
  #     configure :title, :string 
  #     configure :description, :text 
  #     configure :course_id, :integer 
  #     configure :html_embed_for_video, :text 
  #     configure :running_time, :time 
  #     configure :user_id, :integer 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime   #   # Sections:
  #   list do; end
